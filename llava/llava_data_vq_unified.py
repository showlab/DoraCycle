...
class LLaVADataset(Dataset):
    ...
    def __init__(self,
        ...
        if phase == "pretrain":
            data_file_path = os.environ.get("LLAVA_PRETRAIN_JSON", "<YOUR_BLIP_LAION_558K_JSON_PATH>")
            self.image_root = os.environ.get("LLAVA_PRETRAIN_IMAGE_ROOT", "<YOUR_PRETRAIN_IMAGE_ROOT>")
        else:
            data_file_path = os.environ.get("LLAVA_TUNE_JSON", "<YOUR_LLAVA_MIX665K_JSON_PATH>")
            self.image_root = os.environ.get("LLAVA_TUNE_IMAGE_ROOT", "<YOUR_TUNING_IMAGE_ROOT>")
    ...
    def __getitem__(self, i):
        ...
        try:
            ...
            image = image_transform(image, resolution=self.image_size)
        except:
...
if __name__ == '__main__':
    import transformers
    pretrained_model_path = os.environ.get("PHI15_PATH", "microsoft/phi-1_5")
